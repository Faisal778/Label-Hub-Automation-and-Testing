...
public class AnnotatorSignUp {
    private WebDriver driver;

    public AnnotatorSignUp() {
    ...
    public void fillOutSignUpFormWithValidInfo() throws InterruptedException {
        ...
        WebElement annotator = driver.findElement(By.xpath("/html/body/div/div/section[1]/div/div/div[2]/section[1]/div[2]/div/select/option[2]"));
    ...
    public static void main(String[] args) throws InterruptedException {
        AnnotatorSignUp signUp = new AnnotatorSignUp();
